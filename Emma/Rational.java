...
public class Rational {
    ...
    public Rational plus(Rational b) {
		...
		System.out.println();
		System.out.println("a: "+a._numerator+"; b: "+b._numerator+"; x: "+x);
		System.out.println("A: "+a._denominator+"; B: "+b._denominator+"; y: "+y);
		System.out.println("[LCM] A: "+a._denominator+"; B: "+b._denominator+"; y: "+lcm(a._denominator, b._denominator));
    ...
    public Rational minus(Rational b) {
        ...
        System.out.println("MINUS: ("+a._numerator+"/"+a._denominator+") - ("+ b._numerator+"/"+b._denominator+") = "+a.plus(c));
        return a.plus(c);
    }
    ...
    public Rational divides(Rational b) {
        ...
        System.out.println("DIVIDES: ("+a._numerator+"/"+a._denominator+") / ("+ b._numerator+"/"+b._denominator+") = "+a.times(c));
        return a.times(c);
    }
